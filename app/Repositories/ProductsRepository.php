...
final class ProductsRepository
{
    ...
    {
        $stmt = $this->pdo->query('SELECT * FROM products WHERE deleted_at IS NULL ORDER BY created_at DESC');
    ...
    {
        $stmt = $this->pdo->prepare('SELECT * FROM products WHERE id = :id AND deleted_at IS NULL');
        $stmt->execute(['id' => $id]);
